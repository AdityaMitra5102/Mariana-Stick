...
sudo apt install -y python3-pip build-essential libffi-dev libssl-dev
...
sudo python3 -m pip install gpiozero requests rpi-lgpio --break-system-package --upgrade --ignore-installed
